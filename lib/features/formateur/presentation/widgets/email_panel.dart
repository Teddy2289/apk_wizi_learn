...
class _EmailPanelState extends State<EmailPanel> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _sendEmail() async {
    ...
    if (_subjectController.text.isEmpty || _messageController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Le sujet et le message sont requis'), backgroundColor: FormateurTheme.error),
      );
      return;
    }
    ...
    try {
      await _apiClient.post('/formateur/send-email', data: {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Email envoyé à ${_selectedIds.length} stagiaire(s)'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Sujet
          const Text('CONTENU DE L\'EMAIL', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 12, color: FormateurTheme.textTertiary, letterSpacing: 1.2)),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: Colors.green, // Email specific color
