                                      ...
                                      onTap: () async {
                                        if (!isWatched) {
                                          final resp = await _mediaRepository
                                              .markMediaAsWatchedWithResponse(
                                                media.id,
                                              );
                                          final success =
                                              resp['success'] == true;
                                        ...
                                        final selectedFormation = formations
                                            .firstWhere(
                                              (f) =>
                                                  f.id == _selectedFormationId,
                                              orElse: () => formations.first,
                                            );
